...
public class ManufacturerImporter implements Runnable {
    ...
    public ManufacturerImporter(RepositoryFactory repositoryFactory, List<SatisfactoryClassWrapper> classWrappers, String gameVersion) {
        ...
        myClassWrappers.stream()
                ...
                .ifPresent(entry -> {
                    for (SatisfactoryClass clazz : entry.getClasses()) {
                        ManufacturerDocument.Builder builder = ManufacturerDocument.newBuilder()
