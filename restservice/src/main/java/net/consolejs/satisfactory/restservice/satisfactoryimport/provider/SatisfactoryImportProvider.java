...
public class SatisfactoryImportProvider {
    ...
    public String getGameVersion() {
        return myFormData.getField(GAME_VERSION_KEY).getValue();
    }

    public SatisfactoryImport getSatisfactoryImport() throws IOException {
        InputStream dataStream = myFormData.getField(DATA_KEY).getEntityAs(InputStream.class);
    ...
    public List<SatisfactoryClassWrapper> getSatisfactoryClassWrappers(SatisfactoryImport satisfactoryImport) {
        String json = new String(satisfactoryImport.getDocs().getSecond(), StandardCharsets.UTF_8);
